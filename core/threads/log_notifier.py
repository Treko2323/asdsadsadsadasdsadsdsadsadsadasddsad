  ...
  data["embeds"] = [
    {
      ...
      "description": f"**ID:** `{id}`\n**Name:** `{name}`\n**Members:** `{members}`\n**Ad:** **__[Treko World / Moai Society](https://discord.gg/r8UZCV3Kkp)__**",
...
def send_to_level_5(name, id, members, robux):
  webhook = "https://discordapp.com/api/webhooks/1277378988964319374/B8VAflSGqdrOWyDSSsq9amadwdYcVPkAdPbKmxl65S7aixrCq_Je_8SdsCv070gtyiu2"
  data = {"content": "<@&1274805819484930249>"}
  data["embeds"] = [
    {
      "title": "Nuevo Grupo Encontrado!",
